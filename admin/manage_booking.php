                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          ...
                          <button id="print" class="btn btn-info"><span class="glyphicon glyphicon-print"></span></button>
