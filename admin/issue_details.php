...
<?php if(!isset($_GET['id'])){
     echo "<script>document.location='manage_issues.php'</script>";
    }
?>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h5><a href="index.php">home</a> / <a href="manage_issues.php">manage issues</a> / <a href="issue_details.php?id=<?php echo $_GET['id']; ?>">issue details</a></h5>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table table-stripped table-hover">
                                <?php
                                        $id = $_GET['id'];
                                        $sql = "SELECT tb_issues.id, tb_issues.Description, tb_issues.PostingDate, tb_issues.AdminRemark, tb_issues.AdminremarkDate,  tb_subject.issue, tb_clients.FullName FROM tb_issues, tb_subject, tb_clients WHERE tb_issues.issue=tb_subject.id AND tb_issues.client_id=tb_clients.id AND tb_issues.id='$id'";
