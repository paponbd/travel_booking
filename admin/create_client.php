...
<?php
    ...
    if(isset($_POST['create'])){
        ...
        $sql = "INSERT INTO tb_clients (FullName, MobileNumber, EmailId, Password, image) VALUES('$name', '$phone', '$email', '$password', '$image')";
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h5><a href="index.php">home</a> / <a href="create_client.php">create client</a></h5>
            </div>
