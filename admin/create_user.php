...
<?php
    ...
    if(isset($_POST['create'])){
        ...
        $sql = "INSERT INTO tb_users (name, email, password, type, image) VALUES('$name', '$email', '$password', '$type', '$image')";
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h5><a href="index.php">home</a> / <a href="create_user.php">user</a></h5>
            </div>
