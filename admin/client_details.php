...
<?php
    ...
    if(isset($_POST['update'])){
        ...
        $type = $_POST['type'];
        $sql = "UPDATE tb_users SET name='$name', email='$email', phone='$phone', password='$password', type='$type' WHERE id='$id'";
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h5><a href="index.php">home</a> / <a href="manage_client.php">manage clients</a> / <a href="client_details.php?id=<?php echo $_GET['id']; ?>">client details</a></h5>
            </div>
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label><img src="../images/clients/<?php echo $result->image; ?>" alt='image' height='170' width='150'></label>
                                        <a href="change_client_image.php?id=<?php echo $result->id; ?>"><button class="btn btn-info">CHANGE IMAGE</button></a>
                                    </div>
