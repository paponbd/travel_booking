    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h5><a href="index.php">home</a> / <a href="manage_category.php?id=<?php echo $_GET['id']; ?>">categories</a></h5>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a href="manage_category.php" class="btn btn-info">Category List</a>
                            <a href="manage_category.php" class="btn btn-info">Add Category</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <button class="glyphicon glyphicon-pencil btn btn-info" onclick="edit_category()"></button>
                                        <a href="manage_category.php?delete_id=<?php echo $result->id; ?>" class="btn btn-danger" onclick="return confirm('Do you really want to delete this category!!!')"><span class="glyphicon glyphicon-trash"></span></a>
                                    </td>
