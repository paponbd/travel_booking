<?php include "includes/header.php"; ?>
	...
	<div class="about">
		<div class="about-heading">
			<div class="container">
				<h2 class="wow fadeInDown animated" data-wow-delay=".5s">What people say about us</h2>
				<p class="wow fadeInUp animated" data-wow-delay=".5s">ভিসা প্রোসেসিং এর খরচ সহ, কোন ধরনের ই টোকেন,দালালের পিছনে ঘোরাগুরি না করে একই খরচে ঘুরে আসুন দার্জিলিং+ভুটান থেকে,ভিসা প্রোসেসিং করার দায়িত্ব আমাদের।</p>
			</div>
		</div>
		<div class="about-top">
			<div class="container">
